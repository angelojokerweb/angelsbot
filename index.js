...
const config = {
    A187: '🔥J3FFBOT🔥',
    instagram: 'https://instagram.com/angelocarloslopes?igshid=djepqyqm0yzs',
    nomer: 'wa.me/+5564992606313',
    aktif: '24 JAM',
    youtube: 'OFF',
    whatsapp: 'OFF',
...
client.on('message-new', async (m) => {
   ...
   switch (prefix) {
	   ...
	   case 'dono':
		   ...
		   buffer = await getBuffer(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRhSmt93dmaxZkmcv8zzNMA7_c7zSOXnpxQhg&usqp=CAU`)
		   client.sendMessage(from, buffer, image, {quoted: mek, caption: '*DONO:* ÂNGELO\n *Whatsapp:* wa.me/+5564992606313'})
		   break
       case 'menu2':
